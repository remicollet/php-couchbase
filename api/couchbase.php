...
namespace Couchbase {
     ...
     * @see \Couchbase\Bucket::setTranscoder()
     */
    function passthruEncoder(string $value) {}
    ...
    final class Bucket {
         ...
         *   More details about K/V operations for PHP SDK
         */
        final public function getAndTouch(mixed $ids, int $expiry, array $options = []) {}
         ...
         */
        final public function getFromReplica(mixed $ids, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        final public function remove(mixed $ids, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        final public function touch(mixed $ids, int $expiry, array $options = []) {}
         ...
         *   More details about K/V operations for PHP SDK
         */
        final public function counter(mixed $ids, int $delta = 1, array $options = []) {}
         ...
         *   Overview of Sub-Document Operations
         */
        final public function queueAdd(string $id, mixed $value) {}
    ...
    final class BucketManager {
         ...
         */
        final public function createN1qlPrimaryIndex(string $customName = '', bool $ignoreIfExist = false, bool $defer = false) {}
         ...
         * @param bool $defer true to defer index building.
         */
        final public function createN1qlIndex(string $name, array $fields, string $whereClause = '', bool $ignoreIfExist = false, bool $defer = false) {}
         ...
         *   will be thrown unless this is set to true.
         */
        final public function dropN1qlPrimaryIndex(string $customName = '', bool $ignoreIfNotExist = false) {}
         ...
         *   will be thrown unless this is set to true.
         */
        final public function dropN1qlIndex(string $name, bool $ignoreIfNotExist = false) {}
    }
    ...
    final class ViewQuery implements ViewQueryEncodable {
         ...
         * @return ViewQuery
         */
        final public function reduce(bool $reduce) {}
         ...
         */
        final public function group(bool $group) {}
         ...
         * @return ViewQuery
         */
        final public function range(mixed $startKey, mixed $endKey, bool $inclusiveEnd = false) {}
    ...
    final class SpatialViewQuery implements ViewQueryEncodable {
         ...
         */
        final public function bbox(array $bbox) {}
    ...
    final class N1qlQuery {
         ...
         * @return N1qlQuery
         */
        final public static function fromString(string $statement) {}
         ...
         * @return N1qlQuery
         */
        final public function adhoc(bool $adhoc) {}
         ...
         * @see \Couchbase\ClassicAuthenticator
         */
        final public function crossBucket(bool $crossBucket) {}
    ...
    final class MutateInBuilder {
         ...
         * @return MutateInBuilder
         */
        final public function insert(string $path, mixed $value, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function upsert(string $path, mixed $value, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function arrayPrepend(string $path, mixed $value, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function arrayPrependAll(string $path, array $values, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function arrayAppend(string $path, mixed $value, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function arrayAppendAll(string $path, array $values, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function arrayInsertAll(string $path, array $values) {}
         ...
         * @return MutateInBuilder
         */
        final public function arrayAddUnique(string $path, mixed $value, bool $createParents = false) {}
         ...
         * @return MutateInBuilder
         */
        final public function counter(string $path, int $delta, bool $createParents = false) {}
    ...
    final class SearchQuery implements JsonSerializable {
         ...
         */
        final public static function booleanField(bool $value) {}
         ...
         * @return SearchQuery
         */
        final public function explain(bool $explain) {}
    ...
    final class ConjunctionSearchQuery implements JsonSerializable, SearchQueryPart {
         ...
         * @return ConjunctionSearchQuery
         */
        final public function every(SearchQueryPart ...$queries) {}
    }
    ...
    final class DisjunctionSearchQuery implements JsonSerializable, SearchQueryPart {
         ...
         * @return DisjunctionSearchQuery
         */
        final public function either(SearchQueryPart ...$queries) {}
    ...
    final class DateRangeSearchQuery implements JsonSerializable, SearchQueryPart {
         ...
         * @return DateRangeSearchQuery
         */
        final public function start(mixed $start, bool $inclusive = true) {}
         ...
         * @return DateRangeSearchQuery
         */
        final public function end(mixed $end, bool $inclusive = false) {}
    ...
    final class NumericRangeSearchQuery implements JsonSerializable, SearchQueryPart {
         ...
         * @return NumericRangeSearchQuery
         */
        final public function min(float $min, bool $inclusive = true) {}
         ...
         * @return NumericRangeSearchQuery
         */
        final public function max(float $max, bool $inclusive = false) {}
    }
