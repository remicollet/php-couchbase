...
zend_function_entry search_query_methods[] = {
    PHP_ME(SearchQuery, __construct, ai_SearchQuery_construct, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL | ZEND_ACC_CTOR)
    PHP_ME(SearchQuery, jsonSerialize, ai_SearchQuery_none, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, booleanField, ai_SearchQuery_booleanField, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, boolean, ai_SearchQuery_none, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, conjuncts, ai_SearchQuery_conjuncts, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, dateRange, ai_SearchQuery_none, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, disjuncts, ai_SearchQuery_disjuncts, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, docId, ai_SearchQuery_docId, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, match, ai_SearchQuery_match, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, matchAll, ai_SearchQuery_none, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, matchNone, ai_SearchQuery_none, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, matchPhrase, ai_SearchQuery_matchPhrase, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, numericRange, ai_SearchQuery_none, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, phrase, ai_SearchQuery_phrase, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, prefix, ai_SearchQuery_prefix, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    ...
    PHP_ME(SearchQuery, numericRangeFacet, ai_SearchQuery_facet, ZEND_ACC_STATIC | ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, limit, ai_SearchQuery_limit, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, skip, ai_SearchQuery_skip, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(SearchQuery, explain, ai_SearchQuery_explain, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
