...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_MetaData_status, IS_STRING, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_MetaData_requestId, IS_STRING, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_MetaData_clientContextId, IS_STRING, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_MetaData_signature, IS_OBJECT, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_MetaData_errors, IS_ARRAY, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_MetaData_warnings, IS_ARRAY, 1)
ZEND_END_ARG_INFO()
...
static const zend_function_entry pcbc_meta_data_methods[] = {
    ...
    PHP_ABSTRACT_ME(MetaData, requestId, ai_MetaData_requestId)
    PHP_ABSTRACT_ME(MetaData, clientContextId, ai_MetaData_clientContextId)
    PHP_ABSTRACT_ME(MetaData, signature, ai_MetaData_signature)
...
PHP_METHOD(MetaDataImpl, status);
PHP_METHOD(MetaDataImpl, requestId);
PHP_METHOD(MetaDataImpl, clientContextId);
PHP_METHOD(MetaDataImpl, signature);
...
static const zend_function_entry pcbc_meta_data_impl_methods[] = {
    PHP_ME(MetaDataImpl, status, ai_MetaData_status, ZEND_ACC_PUBLIC)
    PHP_ME(MetaDataImpl, requestId, ai_MetaData_requestId, ZEND_ACC_PUBLIC)
    PHP_ME(MetaDataImpl, clientContextId, ai_MetaData_clientContextId, ZEND_ACC_PUBLIC)
    PHP_ME(MetaDataImpl, signature, ai_MetaData_signature, ZEND_ACC_PUBLIC)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_SearchMetaData_metrics, IS_OBJECT, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_Result_expiration, IS_LONG, 1)
ZEND_END_ARG_INFO()
...
static const zend_function_entry pcbc_result_methods[] = {
    ...
    PHP_ABSTRACT_ME(Result, expiration, ai_Result_expiration)
    PHP_FE_END
};

PHP_METHOD(ResultImpl, cas);
PHP_METHOD(ResultImpl, expiration);
...
static const zend_function_entry pcbc_result_impl_methods[] = {
    ...
    PHP_ME(ResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
    PHP_FE_END
};

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_GetResult_content, IS_OBJECT, 1)
ZEND_END_ARG_INFO()
...
PHP_METHOD(GetResultImpl, expiration);
...
static const zend_function_entry pcbc_get_result_impl_methods[] = {
    ...
    PHP_ME(GetResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
...
static const zend_function_entry pcbc_get_replica_result_methods[] = {
    ...
    PHP_ABSTRACT_ME(GetReplicaResult, isMaster, ai_GetReplicaResult_isMaster)
    PHP_FE_END
};

PHP_METHOD(GetReplicaResultImpl, cas);
PHP_METHOD(GetReplicaResultImpl, expiration);
PHP_METHOD(GetReplicaResultImpl, content);
PHP_METHOD(GetReplicaResultImpl, isMaster);
...
static const zend_function_entry pcbc_get_replica_result_impl_methods[] = {
    ...
    PHP_ME(GetReplicaResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
    PHP_ME(GetReplicaResultImpl, content, ai_GetReplicaResult_content, ZEND_ACC_PUBLIC)
    PHP_ME(GetReplicaResultImpl, isMaster, ai_GetReplicaResult_isMaster, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
...
PHP_METHOD(ExistsResultImpl, expiration);
...
static const zend_function_entry pcbc_exists_result_impl_methods[] = {
    ...
    PHP_ME(ExistsResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
...
PHP_METHOD(MutationResultImpl, expiration);
...
static const zend_function_entry pcbc_store_result_impl_methods[] = {
    ...
    PHP_ME(StoreResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
...
PHP_METHOD(CounterResultImpl, expiration);
...
static const zend_function_entry pcbc_counter_result_impl_methods[] = {
    ...
    PHP_ME(CounterResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
...
ZEND_BEGIN_ARG_INFO_EX(ai_LookupInResult_exists, 0, 0, 1)
ZEND_ARG_TYPE_INFO(0, index, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
PHP_METHOD(LookupInResultImpl, expiration);
...
static const zend_function_entry pcbc_lookup_in_result_impl_methods[] = {
    ...
    PHP_ME(LookupInResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
...
PHP_METHOD(MutateInResultImpl, expiration);
...
static const zend_function_entry pcbc_mutate_in_result_impl_methods[] = {
    ...
    PHP_ME(MutateInResultImpl, expiration, ai_Result_expiration, ZEND_ACC_PUBLIC)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO(ai_QueryResult_metadata, \\Couchbase\\MetaData, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO(ai_AnalyticsQueryResult_metadata, \\Couchbase\\MetaData, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_AnalyticsQueryResult_rows, IS_ARRAY, 1)
ZEND_END_ARG_INFO()

zend_class_entry *pcbc_analytics_query_result_ce;
static const zend_function_entry pcbc_analytics_query_result_methods[] = {
    PHP_ABSTRACT_ME(AnalyticsQueryResult, metadata, ai_AnalyticsQueryResult_metadata)
    PHP_ABSTRACT_ME(AnalyticsQueryResult, rows, ai_AnalyticsQueryResult_rows)
    PHP_FE_END
};

PHP_METHOD(AnalyticsQueryResultImpl, metadata);
PHP_METHOD(AnalyticsQueryResultImpl, rows);

zend_class_entry *pcbc_analytics_query_result_impl_ce;
static const zend_function_entry pcbc_analytics_query_result_impl_methods[] = {
    PHP_ME(AnalyticsQueryResultImpl, metadata, ai_AnalyticsQueryResult_metadata, ZEND_ACC_PUBLIC)
    PHP_ME(AnalyticsQueryResultImpl, rows, ai_AnalyticsQueryResult_rows, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_SearchResult_hits, IS_ARRAY, 1)
ZEND_END_ARG_INFO()
...
static const zend_function_entry pcbc_search_result_methods[] = {
    ...
    PHP_ABSTRACT_ME(SearchResult, hits, ai_SearchResult_hits)
    PHP_FE_END
};

PHP_METHOD(SearchResultImpl, metadata);
PHP_METHOD(SearchResultImpl, facets);
PHP_METHOD(SearchResultImpl, hits);
...
static const zend_function_entry pcbc_search_result_impl_methods[] = {
    ...
    PHP_ME(SearchResultImpl, hits, ai_SearchResult_hits, ZEND_ACC_PUBLIC)
    PHP_FE_END
};
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_ViewResultEntry_id, IS_STRING, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO(ai_ViewResultEntry_key, IS_OBJECT, 1)
ZEND_END_ARG_INFO()
...
PHP_MINIT_FUNCTION(Result)
{
    ...
    INIT_NS_CLASS_ENTRY(ce, "Couchbase", "MetaData", pcbc_meta_data_methods);
    pcbc_meta_data_ce = zend_register_internal_interface(&ce TSRMLS_CC);

    INIT_NS_CLASS_ENTRY(ce, "Couchbase", "MetaDataImpl", pcbc_meta_data_impl_methods);
    pcbc_meta_data_impl_ce = zend_register_internal_class(&ce TSRMLS_CC);
    zend_class_implements(pcbc_meta_data_impl_ce TSRMLS_CC, 1, pcbc_meta_data_ce);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("status"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("request_id"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("client_context_id"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("signature"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("errors"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("warnings"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_meta_data_impl_ce, ZEND_STRL("metrics"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_get_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_get_replica_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_get_replica_result_impl_ce, ZEND_STRL("is_master"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_exists_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_mutation_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_store_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_class_implements(pcbc_counter_result_ce TSRMLS_CC, 1, pcbc_result_ce);
    ...
    zend_declare_property_null(pcbc_counter_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_lookup_in_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_mutate_in_result_impl_ce, ZEND_STRL("expiration"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    INIT_NS_CLASS_ENTRY(ce, "Couchbase", "AnalyticsQueryResult", pcbc_analytics_query_result_methods);
    pcbc_analytics_query_result_ce = zend_register_internal_interface(&ce TSRMLS_CC);

    INIT_NS_CLASS_ENTRY(ce, "Couchbase", "AnalyticsQueryResultImpl", pcbc_analytics_query_result_impl_methods);
    pcbc_analytics_query_result_impl_ce = zend_register_internal_class(&ce TSRMLS_CC);
    zend_class_implements(pcbc_analytics_query_result_impl_ce TSRMLS_CC, 1, pcbc_analytics_query_result_ce);
    zend_declare_property_null(pcbc_analytics_query_result_impl_ce, ZEND_STRL("status"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_analytics_query_result_impl_ce, ZEND_STRL("meta"), ZEND_ACC_PRIVATE TSRMLS_CC);
    zend_declare_property_null(pcbc_analytics_query_result_impl_ce, ZEND_STRL("rows"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    zend_declare_property_null(pcbc_search_result_impl_ce, ZEND_STRL("hits"), ZEND_ACC_PRIVATE TSRMLS_CC);
    ...
    INIT_NS_CLASS_ENTRY(ce, "Couchbase", "ViewResultEntry", pcbc_view_result_entry_methods);
...
PHP_METHOD(MutationTokenImpl, partitionId)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_get_result_impl_ce, getThis(), ZEND_STRL("partition_id"), 0, &rv);
    ZVAL_DEREF(prop);
...
PHP_METHOD(MutationTokenImpl, partitionUuid)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_get_result_impl_ce, getThis(), ZEND_STRL("partition_uuid"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MutationTokenImpl, sequenceNumber)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_get_result_impl_ce, getThis(), ZEND_STRL("sequence_number"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MutationTokenImpl, bucketName)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_result_impl_ce, getThis(), ZEND_STRL("bucket_name"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(ResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(GetResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_get_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(GetReplicaResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_get_replica_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(GetReplicaResultImpl, isMaster)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_get_replica_result_impl_ce, getThis(), ZEND_STRL("is_master"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(ExistsResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_exists_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MutationResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_mutation_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(StoreResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_store_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(CounterResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_counter_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(LookupInResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_lookup_in_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MutateInResultImpl, expiration)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_mutate_in_result_impl_ce, getThis(), ZEND_STRL("expiration"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MetaDataImpl, status)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_meta_data_impl_ce, getThis(), ZEND_STRL("status"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MetaDataImpl, requestId)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_meta_data_impl_ce, getThis(), ZEND_STRL("request_id"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MetaDataImpl, clientContextId)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_meta_data_impl_ce, getThis(), ZEND_STRL("client_context_id"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MetaDataImpl, signature)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_meta_data_impl_ce, getThis(), ZEND_STRL("signature"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MetaDataImpl, errors)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_meta_data_impl_ce, getThis(), ZEND_STRL("errors"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(MetaDataImpl, warnings)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_meta_data_impl_ce, getThis(), ZEND_STRL("warnings"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(AnalyticsQueryResultImpl, metadata)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_analytics_query_result_impl_ce, getThis(), ZEND_STRL("meta"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(AnalyticsQueryResultImpl, rows)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_analytics_query_result_impl_ce, getThis(), ZEND_STRL("rows"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
...
PHP_METHOD(SearchResultImpl, hits)
{
    ...
    zval *prop, rv;
    prop = zend_read_property(pcbc_search_result_impl_ce, getThis(), ZEND_STRL("hits"), 0, &rv);
    ZVAL_DEREF(prop);
    ZVAL_COPY(return_value, prop);
}
