...
static void term_search_query_free_object(zend_object *object TSRMLS_DC) /* {{{ */
{
...
static zend_object *term_search_query_create_object(zend_class_entry *class_type TSRMLS_DC)
{
