...
zend_function_entry geo_distance_search_query_methods[] = {
    ...
    PHP_ME(GeoDistanceSearchQuery, jsonSerialize, ai_GeoDistanceSearchQuery_none, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(GeoDistanceSearchQuery, boost, ai_GeoDistanceSearchQuery_boost, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(GeoDistanceSearchQuery, field, ai_GeoDistanceSearchQuery_field, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_FE_END
};
// clang-format on
...
PHP_MINIT_FUNCTION(GeoDistanceSearchQuery)
{
    ...
    PCBC_CE_FLAGS_FINAL(pcbc_geo_distance_search_query_ce);
