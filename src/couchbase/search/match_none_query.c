...
static void match_none_search_query_free_object(zend_object *object TSRMLS_DC) /* {{{ */
{
...
static zend_object *match_none_search_query_create_object(zend_class_entry *class_type TSRMLS_DC)
{
...
PHP_MINIT_FUNCTION(MatchNoneSearchQuery)
{
    ...
    zend_class_implements(pcbc_match_none_search_query_ce TSRMLS_CC, 1, pcbc_json_serializable_ce);
