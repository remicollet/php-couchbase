...
zend_function_entry geo_bounding_box_search_query_methods[] = {
    ...
    PHP_ME(GeoBoundingBoxSearchQuery, jsonSerialize, ai_GeoBoundingBoxSearchQuery_none, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(GeoBoundingBoxSearchQuery, boost, ai_GeoBoundingBoxSearchQuery_boost, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(GeoBoundingBoxSearchQuery, field, ai_GeoBoundingBoxSearchQuery_field, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_FE_END
};
// clang-format on
...
PHP_MINIT_FUNCTION(GeoBoundingBoxSearchQuery)
{
    ...
    PCBC_CE_FLAGS_FINAL(pcbc_geo_bounding_box_search_query_ce);
