...
zend_function_entry bucket_manager_methods[] = {
    ...
    PHP_ME(BucketManager, getDesignDocument, ai_BucketManager_none, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
    PHP_ME(BucketManager, removeDesignDocument, ai_BucketManager_none, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
