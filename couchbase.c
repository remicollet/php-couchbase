...
/* code generated by 'make phpc' from Makefile.frag */
...
PHP_MINIT_FUNCTION(couchbase)
{
	...
	pcs_file_count = PCS_registerEmbedded(code, "ext/couchbase", sizeof("ext/couchbase") -1, 0);
	if (pcs_file_count == FAILURE) {
            return FAILURE;
        }
